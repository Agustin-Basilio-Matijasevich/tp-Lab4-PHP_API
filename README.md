...
Sin embargo se indica el tipo de dato correspondiente a cada campo ya que asi es almacenado en la Base de Datos y para que de ser necesario se pueda estar seguro de hacer un casteo.  
